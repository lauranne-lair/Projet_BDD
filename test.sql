...
drop trigger check_duree_positive;
drop trigger check_nb_plaques_lot;
drop trigger check_type_plaque;
...
INSERT INTO APPAREIL (ID_APPAREIL, ID_LISTE, DISPO_APPAREIL, POSITION_APPAREIL) VALUES (1, 1, 'O', 1);
...
INSERT INTO EXPERIENCE (ID_EXPERIENCE, ID_LISTE, ID_TECHNICIEN, ID_CHERCHEUR, TYPE_EXPERIENCE, ETAT_EXPERIENCE, DEB_EXPERIENCE, FIN_EXPERIENCE, DUREE_EXPERIENCE, DATE_DEMANDE_EXPERIENCE, DATE_TRANSMISSION_RESULTAT, PRIORITE_EXPERIENCE, FREQUENCE_EXPERIENCE, REPROGR_MAX_EXPERIENCE, COEFF_PRIX_PRIO_EXPERIENCE, VALEUR_BIAIS_A1, VALEUR_BIAIS_A2, VALEUR_BAIS_A3, MOYENNE_EXPERIENCE, ECART_TYPE_EXPERIENCE, NB_RENOUVELLEMENT_EXPERIENCE) VALUES (1, 1, 1, 1, 'TypeExperience', 'EtatExperience', TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-01-10', 'YYYY-MM-DD'), 10, TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-01-10', 'YYYY-MM-DD'), 1, 1, 1, 1, 0.5, 0.7, 1, 50, 5, 3);
...
INSERT INTO GROUPESLOT (ID_GROUPE, ID_EXPERIENCE, ID_PLAQUE, MOYENNE_GROUPE, ECART_TYPE_GROUPE, VALIDITE_GROUPE) VALUES (1, 1, 1, 50, 5, 'O');
...
INSERT INTO PLAQUE (ID_PLAQUE, ID_LOT, TYPE_PLAQUE, NB_EXPERIENCE_PLAQUE, ETAT_PLAQUE) VALUES (1, 1, 96, 50, 'EtatPlaque');
